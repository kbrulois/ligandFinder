...
for(term in c("N", "C")) {
  ...
  shared <- inputs |>
    ...
    layer_conv_1d(32, kernel_size, padding = "same",
                  activation = "gelu", dilation_rate = 1) |>
    #layer_batch_normalization() |>
    layer_conv_1d(64, kernel_size, padding = "same",
                  activation = "gelu", dilation_rate = 2) |>
    #layer_batch_normalization() |>
    layer_dropout(0.3)
  ...
  global_output <- shared |>
    layer_conv_1d(32, kernel_size, activation = "gelu") |>
    layer_global_max_pooling_1d() |>
    layer_dense(1, activation = "sigmoid", name = "global")
