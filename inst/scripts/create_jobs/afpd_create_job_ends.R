...
ligand_list <- openxlsx::read.xlsx("~/R_projects/ligandFinder/inst/extdata/Cyan_peptides_34_Jul2_2026.xlsx")[1:39,]
...
ligand_list[["model"]] <- c("BMP5,31-40", "EDA,63-68", "SIAL,17-23", "BMP4,20-31", "OLFL3,22-31",
                            "MGP,20-34", "MGP,20-36", "MGP,20-33", "STC1,18-29", "STC1,202-212",
                            "PROS,25-37", "ENPP3,31-45", "DKK4,19-35", "GAS6,31-46", "GAS6,31-44",
                            "CC126,27-53", "GNPTG,25-51", "GNPTG,25-44", "GNPTG,25-42", "GNPTG,25-41",
                            "GNPTG,25-34", "SPESP,20-55", "SPESP,20-48", "ASIP,23-56", "NDNF,20-61",
                            "NDNF,20-29", "SCG3,20-54", "SCG3,36-54", "UCMA,27-58", "FAM3B,30-58",
                            "TNFL6,103-116", "ANGL4,26-70", "ANGL4,39-70", "NUCB2,25-106",
                            "SG3A2,22-93", "BRNP3,34-92", "AEBP1,26-66", "CREG2,32-106",
                            "CREG2,32-41")
...
job_dir <- "/oak/stanford/groups/ebutcher/deorphan-AI-ze/scripts/ends"
...
out_dir <- "/scratch/groups/ebutcher/deorphan/models/ends"
